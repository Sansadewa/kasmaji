...
<body>
        <div style="margin :5%">
          <a class="btn btn-primary" href="<?php echo base_url();?>" type="button" style="margin:5px"> << Kembali</a>
                ...
                <tbody>
                  <?php foreach ($topik->result() as $row) { ?>
                    <tr>
                       ...
                       <td><?php echo date("y-m-d, H:i:s", strtotime($row->tgl)); ?></td>  
                      ...
                      <td><?php echo wordwrap(filter_var($row->platform, FILTER_SANITIZE_STRING, FILTER_SANITIZE_ENCODED),30,"<br>\n"); ?></td>
