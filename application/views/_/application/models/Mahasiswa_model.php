...
class Mahasiswa_model extends CI_Model {
    ...
    public function getMahasiswaa(){
      return $this->db->query("SELECT * FROM `TABLE 19`");
    }

    public function masukk($nim,$rank){
      if ($this->db->query("UPDATE sipaju_mahasiswaa SET ranking=".$rank." WHERE nim='".$nim."'")){
        return true;
      } else {return false;}
    }
