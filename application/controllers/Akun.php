...
class Akun extends CI_Controller {
	...
	// public function BTM()
	// {
	// 	$data['btm']= $this->orang_model->get_btm($this->session->userdata('nim'));
	// 	$this->load->view('akunhead');
	...
	// 	switch ($kon) {
	// 		case 'KS':
	// 			$ha=$this->orang_model->getRank('KS');
	// 			break;

	// 		case 'SE':
	// 			$ha=$this->orang_model->getRank('SE');
	// 			break;

	// 		case 'SK':
	// 			$ha=$this->orang_model->getRank('SK');
	// 			break;
	...
	// 		$data['topik']=$this->orang_model->get_mytopik($nimtopik);
	// 		$this->load->view('akunhead');
	...
	// {
	// 	$data['topik']=$this->orang_model->get_alltopik();
	// 	$this->load->view('akunhead');
    ...
    //               		$data['btm']=$this->orang_model->rekap_btm($this->session->userdata('kelas'));
    //                   	$this->load->view('akunhead');
	// 					$this->load->view('allbtm',$data);
    //               } elseif($this->session->userdata('jabatan')==2) { 
    //               		$data['btm']=$this->orang_model->rekap_btm('all');
    //               		$this->load->view('akunhead');
	// 					$this->load->view('allbtm',$data);
	// 					$this->load->view('akunfooter');
    //               } else {
