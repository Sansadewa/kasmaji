        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row text-right">
              <hr class="mb-0">
              <div>
                <a  class="text-right" data-toggle="modal" data-target="#ModalPekerjaanForm" style="color:#259b87;cursor: pointer;">Edit Data Pekerjaan ></a>
              </div>
            </div>
          <div class="row mt-1 justify-content-center">
            <div class="col-lg-12 col-sm-12 col-md-12 ml-lg-4">
              <form class="forms-sample" action="<?php echo base_url().'input/profil' ?>" method="post"> <?php foreach ($pekerjaan->result() as $row) { ?>
                  <br>
                  <div class="row">
                    <div class="form-group col-md-6 col-sm-12">
                      <label for="nim" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Jenis Kegiatan</label>
                      <input class="form-control" id="" value="<?php echo $row->jenis; ?>" readonly>
                    </div>
                    <div class="form-group col-md-3 col-sm-12">
                      <label for="nama" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Status Pekerjaan</label>
                      <input class="form-control" id="thmasuk" value="<?php echo strtoupper($row->status);?>" readonly>
                    </div>
                    <div class="form-group col-md-3 col-sm-12">
                      <label for="nama" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Nama Instansi/Tempat Kerja</label>
                      <input class="form-control" id="thkeluar" value="<?php echo strtoupper($row->tempat_kerja);?>" readonly>
                    </div>
                  </div>

                  <div class="row">
                    <div class="form-group col-md-6 col-sm-12">
                      <label for='email' style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Bidang Pekerjaan</label> 
                      <input class="form-control" value="<?php echo $row->bidang;?>" readonly>
                    </div>
                    <div class="form-group col-md-6">
                      <label for='date' style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Jabatan</label> 
                      <input class="form-control" value="<?php echo $row->jabatan;?>" readonly>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-6 col-sm-12">
                    <label for='email' style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Deskripsi Pekerjaan</label> 
                            <input class="form-control asn" placeholder="Instansi (S2/Profesi)" Value="<?php echo $row->deskripsi_kerja;?>"  readonly>
                        
                    </div>

                    <div class="form-group col-md-6 col-sm-12">
                    <label for='email' style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Rencana Setelah Mendapatkan Surat Izin</label> 
                            <input class="form-control asn" placeholder="Jurusan (S2/Profesi)" Value="<?php echo $row->rencana;?>" readonly>
            ...
            <div id="ModalPekerjaanForm" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url().'input/pekerjaan' ?>" method="post"><?php foreach ($pekerjaan->result() as $row) { ?>
                        <fieldset id="huha">
                                    ...
                                    <div class=" col-sm-9">
                                        <div class="row" style="margin-bottom:0.3em;">
                                            <div class="form-radio col-sm-4">
                                                ...
                                                <input type="radio" class="form-check-input" name="kegiatan" id="bekerja" value="Bekerja" required <?php if($row->jenis=='Bekerja'){echo "checked";} ?>> Bekerja
                                                <i class="input-helper"></i></label>
                                            </div>
                                            <div class="form-radio col-sm-4">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="kegiatan" id="magang" value="Magang" <?php if($row->jenis=='Magang'){echo "checked";} ?>> Magang
                                                <i class="input-helper"></i></label>
                                            </div>
                                            <div class="form-radio col-sm-4">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="kegiatan" id="koas" value="Koas" <?php if($row->jenis=='Koas'){echo "checked";} ?>> Koas
                                                <i class="input-helper"></i></label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="PNS" <?php if($row->jenis=='Koas'){echo "hidden";} ?>>
                                    ...
                                    <div class=" col-sm-9">
                                        <div class="row" style="margin-bottom:0.3em;">
                                            <div class="form-radio col-sm-6">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status_pekerjaan" id="pemerintahan" value="Pemerintahan" required <?php if($row->status=='Pemerintahan'){echo "checked";} ?>> Pegawai Pemerintahan
                                                <i class="input-helper"></i></label>
                                            </div>
                                            <div class="form-radio col-sm-6">
                                                <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="status_pekerjaan" id="swasta" value="Swasta" <?php if($row->status=='Swasta'){echo "checked";} ?>> Pegawai Swasta
                                                <i class="input-helper"></i></label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Instansi/Tempat Kerja</label>
                                    <div class=" col-sm-9">
                                    <input class="form-control asn" placeholder="Instansi/Tempat Kerja" name="tempat_kerja" value="<?php echo $row->tempat_kerja; ?>" >
                                    </div>
                                </div>
                                <div class="form-group row" >
                                ...
                                <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Keterangan Bidang Pekerjaan</label>
                                    <div class=" col-sm-9">
                                    <input class="form-control asn" placeholder="...." name="lainnya" value="<?php if($row->bidang[0]=="("){echo "$row->bidang";}?>" >
                                    </div>
                                </div>
                                ...
                                <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Posisi/Jabatan Struktural</label>
                                    <div class=" col-sm-9">
                                    <input class="form-control asn" placeholder="Posisi/Jabatan Struktural" name="jabatan" value="<?php echo $row->jabatan; ?>">
                                    </div>
                                </div>
                                <div class="form-group row" >
                                <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Deskripsi Pekerjaan</label>
                                    <div class=" col-sm-9">
                                    <textarea class="form-control sdn" placeholder="Deskripsi Pekerjaan" name="deskripsi_pekerjaan" row="4"><?php echo $row->deskripsi_kerja; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" >
                                <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Rencana setelah selesai internship dan mendapatkan surat izin praktek</label>
                                    <div class=" col-sm-9">
                                    <input class="form-control ass" placeholder="Contoh: Spesialis, Profesi, S2, dll" name="rencana" value="<?php echo $row->rencana; ?>">
                                    </div>
                                </div>
                            </div>
