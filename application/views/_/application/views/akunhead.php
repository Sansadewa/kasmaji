        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uii-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url(); ?>akun/abrakadabra">Entri Simulasi Realtime</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url(); ?>akun/simsalabim">Hasil Simulasi Kemaren</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url(); ?>akun/simbagula">Hasil Simulasi Realtime</a>
                </li>
                <!-- <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url(); ?>akun/belomahelah">Hasil Simulasi Realtime</a>
                </li> -->
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>akun/rank">
              <i class="menu-icon mdi mdi-book-open-page-variant"></i>
              <span class="menu-title">Ranking Gaes~</span>
            </a>
          </li>
