        ...
        <div class="row flex-grow">
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              <div class="col">
                <h6 class="display-1 mb-0">IN AWAKENING</h6  >
              </div>
              <!-- <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2></h2>
                <h3 class="font-weight-light">Bebenah data sebentar ya kak!</h3>
              </div> -->
            </div>
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="<?php echo base_url();?>">LAGI NGERESET SIMULASI</a>
              </div>
            </div>
            <div class="row mt-5">
