              ...
              <form class="forms-sample" action="<?php echo base_url().'input/pendidikan' ?>" method="post"> <?php foreach ($pendidikan->result() as $row) { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                      ...
                      <input class="form-control" id="thmasuk" value="<?php echo strtoupper($row->th_masuk);?>" readonly>
                    </div>
                    <div class="form-group col-md-3 col-sm-12">
                      <label for="nama" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Tahun Keluar</label>
                      <input class="form-control" id="thkeluar" value="<?php echo strtoupper($row->th_keluar);?>" readonly>
                    </div>
                  </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive sebuah-tabelWrapper">
              <table id="sebuah-tabel" class="table table-striped table-bordered" cellspacing="0" style="width:100%" width="100%">
                <thead>
                <tr>
                  <th>Nama</th>
            ...
            <div id="ModalPendidikanForm" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url().'input/pendidikan' ?>" method="post"> <?php foreach ($pendidikan->result() as $row) { ?>
                            ...
                            <div class=" col-sm-9">
                                <div class="row" style="margin-bottom:0.3em;">
                                    <div class="form-radio col-sm-3">
                                        ...
                                        <input type="radio" class="form-check-input" name="pendidikan" id="d1" value="D1" required <?php if($row->sedang_or_selesai=='D1'){echo "checked";} ?>> D1
                                        <i class="input-helper"></i></label>
                                    </div>
                                    <div class="form-radio col-sm-3">
                                        <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="pendidikan" id="d2" value="D2" <?php if($row->sedang_or_selesai=='D2'){echo "checked";} ?>> D2
                                        <i class="input-helper"></i></label>
                                    </div>
                                    <div class="form-radio col-sm-3">
                                        <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="pendidikan" id="d3" value="D3" <?php if($row->sedang_or_selesai=='D3'){echo "checked";} ?>> D3
                                        <i class="input-helper"></i></label>
                                    </div>
                                    <div class="form-radio col-sm-3">
                                        <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="pendidikan" id="d4" value="D4" <?php if($row->sedang_or_selesai=='D4'){echo "checked";} ?>> D4/S1
                                        <i class="input-helper"></i></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group  col-md-6">
                                        ...
                                        <input class="form-control" placeholder="Tahun Masuk" name="tahun_masuk" id="tahun_masuk" value="<?php echo $row->th_masuk; ?>" reqiured>
                                    </div>

                                    <div class="form-group  col-md-6">
                                        <label for="tahun_keluar" style="margin-bottom:0.5em;">Tahun Keluar</label>
                                        <input class="form-control" placeholder="Tahun Keluar" name="tahun_keluar" value="<?php echo $row->th_keluar; ?>" reqiured>
                                    </div>
                                    <hr>
                                </div>
                            </div>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class=" col-sm-9">
                                <input class="form-control" placeholder="Instansi Pendidikan" name="instansi" value="<?php echo $row->instansi; ?>" reqiured>
                            </div>
                        </div>
                        <div class="form-group row" style="margin-bottom:0;">
                            <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Jurusan</label>
                            <div class=" col-sm-9">
                                <input class="form-control" placeholder="Jurusan" name="jurusan" value="<?php echo $row->jurusan; ?>" reqiured>
                            </div>
                        </div>
                        <hr>
                        <fieldset id="huha">
                        <div class="form-group row" style="margin-bottom:0.36em;" id="huha">
                            ...
                            <div class="row">
                                ...
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="pascasarjana" id="yes" value="1" required <?php if($row->pascasarjana==1){echo "checked";} ?>> Ya
                                <i class="input-helper"></i></label>
                                </div>
                                <div class="form-radio col-6">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="pascasarjana" id="no" value="0" <?php if($row->pascasarjana==0){echo "checked";} ?>> Tidak
                                <i class="input-helper"></i></label>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="form-group row" id="instansi_lanjut_div" <?php if($row->pascasarjana==0){echo "hidden";} ?>>
                            ...
                            <div class=" col-sm-9">
                                <input class="form-control asn" placeholder="Instansi (S2/Profesi)" value="<?php echo $row->instansi_lanjut; ?>" name="instansi_lanjut">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="jurusan_lanjut_div" <?php if($row->pascasarjana==0){echo "hidden";} ?>>
                            ...
                            <div class=" col-sm-9">
                                <input class="form-control asn" placeholder="Jurusan (S2/Profesi)" value="<?php echo $row->instansi_lanjut; ?>" name="jurusan_lanjut">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            ...
                            <div class=" col-sm-9">
                                <input class="form-control asn" placeholder="Program Beasiswa" value="<?php echo $row->beasiswa; ?>" name="beasiswa">
                            </div>
                        </div>
                        <hr>
