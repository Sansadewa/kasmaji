	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form action="<?php echo base_url().'register/first' ?>" method="post" class="login100-form validate-form flex-sb flex-w">
					<span class="login100-form-title p-b-51">
						Hai, masukkan kode yang dikirim ke email kamu
					</span>
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Code is required">
						<input class="input100" name="key" placeholder="Kode">
