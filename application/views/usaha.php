        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row text-right">
              <hr class="mb-0">
              <div>
                <a  class="text-right" data-toggle="modal" data-target="#ModalUsahaForm" style="color:#259b87;cursor: pointer;">Edit Data Usaha ></a>
              </div>
            </div>
          <div class="row mt-1 justify-content-center">
            <div class="col-lg-12 col-sm-12 col-md-12 ml-lg-4">
              <form class="forms-sample" action="<?php echo base_url().'input/profil' ?>" method="post"> <?php foreach ($usaha->result() as $row) { ?>
                  <br>
                  <div class="row">
                    <div class="form-group col-md-6 col-sm-12">
                      <label for="nim" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Nama Usaha</label>
                      <input class="form-control" id="" value="<?php echo $row->nama_usaha; ?>" readonly>
                    </div>
                    <div class="form-group col-md-3 col-sm-12">
                      <label for="nama" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Bidang Usaha</label>
                      <input class="form-control" id="thmasuk" value="<?php echo strtoupper($row->bidang_usaha);?>" readonly>
                    </div>
                    <div class="form-group col-md-3 col-sm-12">
                      <label for="nama" style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Alamat Usaha</label>
                      <input class="form-control" id="thkeluar" value="<?php echo strtoupper($row->alamat_usaha);?>" readonly>
                    </div>
                  </div>

                  <div class="row">
                    <div class="form-group col-md-12 col-sm-12">
                    <label for='email' style="line-height: 15px; margin-bottom:0.7em; font-size: 15px; ">Deskripsi Usaha</label> 
                            <input class="form-control asn" placeholder="Instansi (S2/Profesi)" Value="<?php echo $row->deskripsi_usaha;?>"  readonly>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive sebuah-tabelWrapper" style="width:100%" width="500px">
              <table id="sebuah-tabel" class="table table-striped" style="width:100%" width="100%">
                ...
                <tbody>
                  <?php foreach ($tbl_usaha->result() as $row2) { 
                    ?>
                    <tr>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url().'input/pekerjaan' ?>" method="post"><?php foreach ($usaha->result() as $row) { ?>
                            ...
                            <div class="form-group row" >
                                ...
                                <div class=" col-sm-9">
                                    <input class="form-control ass" placeholder="Contoh: CV. Putra Perkasa" name="nama_usaha" value="<?php echo $row->nama_usaha; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" >
                                ...
                                <div class=" col-sm-9">
                                    <textarea class="form-control ass" placeholder="Jalan/Kota/Provinsi" row="4" name="alamat_usaha"><?php echo wordwrap($row->alamat_usaha,15,"<br>\n"); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" >
                                ...
                                <div class=" col-sm-9">
                                    <textarea class="form-control ass" placeholder="Bekerja Pada Bidang .." row="4" name="deskripsi_usaha"><?php echo wordwrap($row->deskripsi_usaha,15,"<br>\n"); ?></textarea>
                                </div>
                            </div>
