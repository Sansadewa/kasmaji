	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form action="<?php echo base_url().'login/identify' ?>" method="post" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-24">
						...
						<div>
							<a href="<?php echo base_url();?>register/request" class="txt1">
								Aktivasi Akunmu disini!
							</a>
						</div>
					</div>
