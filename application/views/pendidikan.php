					...
					<div class="card-body">
						...
						<div class="table-responsive sebuah-tabelWrapper">
							<table id="sebuah-tabel" class="table table-striped" cellspacing="0" style="width:100%"
								...
								<tbody>
									<?php foreach ($tbl_pendidikan->result() as $row2) { if($row2->username=="ADMIN123456789"){continue;} ?>
									<tr>
                ...
                <div id="PNSwasta" <?php if($row->didikprofesi=='Ya'){echo "";}else{echo "hidden";} ?>>
                  <div class="form-group row" >
                      <label class="col-form-label col-sm-3" style="line-height=0;vertical-align: middle">Rencana setelah mendapat surat tanda registrasi profesi.<br><br>(Untuk koas, setelah internship dan mendapat surat ijin praktik)</label>
                          <div class=" col-sm-9">
                          <textarea class="form-control ass" placeholder="Tuliskan selengkap mungkin bagaimana anda ingin orang lain mendapatkan informasi tentang rencana karir anda setelah selesai menempuh pendidikan profesi" row="12" name="rencana" minlength="100" style="height: 100%"><?php echo $row->rencana; ?></textarea>
                          </div>
                  </div>
                  <div class="row">
