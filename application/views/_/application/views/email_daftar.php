          ...
          <tr>
            <td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" style="font-size: 32px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;" class="padding-copy">Aktivasi SIPAJU</td>
                </tr>
              </table>
         ...
         <tr>
          <td style="padding: 10px 0 0 0; border-top: 1px dashed #aaaaaa;"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" style="font-size: 15px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding-copy">Kode Unik untuk akun <?php echo $nim.' adalah <br>'.$code;?></td>
              </tr>
              <tr>
                <td align="left" style="font-size: 15px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding-copy">Jika Anda ingin mengaktifkan akun SIPAJU, maka masukkan kode unik pada</td>
              </tr>
            </table>
          </td>
        </tr>
                      ...
                      <tr>
                        <td align="center" style="padding-top: 25px;" class="padding">
                          <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                            <tr>
                              <td align="center" style="border-radius: 3px;" bgcolor="#256F9C"><a href="<?php echo base_url();?>register" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">Aktivasi SIPAJU</a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
